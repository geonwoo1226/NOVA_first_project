...
class LCD_Temp:
    ...
    def __init__(self):
        ...
        self.warning_print = Thread(target=self.warning_lcd)
    ...
    def publish_ok(self, client, userdata, mid):
        print(client, userdata, mid)
        print("사용자에게 메세지를 전송하였습니다.")
        
    
    def warning_lcd(self):
        while True:
    ...
    def detection(self):
        ...
        self.warning_print.start()
        try:
            self.led_switch.join()
            self.kitchen_buzzer.join()
            self.warning_print.join()
        ...
        while True:
            ...
            try:
                ...
                if humi >= 90 :
                    ...
                    result = self.mqtt_client.publish("home/warning", "Fire Outbreak")
                    print("호출결과 : ", result)
                    time.sleep(0.1)
